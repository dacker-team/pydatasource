...
def date_range_params(period_config, comparison, period, reference_date):
    ...
    elif period_config == "l365d":
        start_date = (today + relativedelta(days=-364)).strftime("%Y-%m-%d")
        end_date = today.strftime("%Y-%m-%d 23:59:59")
    ...
    elif period_config == "month":
        start_date = today.strftime("%Y-%m-01")
        end_date = (today + relativedelta(day=1, months=+1, days=-1)).strftime("%Y-%m-%d 23:59:59")
